...
<head>
    ...
    <link href="public/styles/errorStyle.css" rel="stylesheet">
    <script src="public/js/errorScript.js" async></script>
</head>
<body>
...
<div class="container">
    ...
    if(isset($_SESSION['success'])){?>
        <div class="bg-success rounded text-white">
            <p class="text-center p-3"><?php echo $_SESSION['success']?></p>
        </div>
    <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" name="openEditModal" class="btn btn-primary" data-bs-target="#modal"
                                ...
                                onclick="editButtonOnclick(this.id)">Update
                        </button>
                    </div>
                    <div class="col">
    ...
    require_once 'Application/View/ModalWindow.php';
    ?>
</div>
</body>
